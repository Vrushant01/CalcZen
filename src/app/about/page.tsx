...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "About CalcZen — Free Online Calculators",
    description:
      "Learn about CalcZen and our mission to deliver free, accurate online calculators with transparent formulas, clear methods, and a clean user experience.",
  ...
  alternates: {
    canonical: "https://calczen.in/about",
  },
};
      ...
      <PageShell>
        ...
        >
          ...
          <LegalSection title="What we offer">
            ...
            <p>
              See everything on our <Link to="/calculators">all calculators</Link> page or browse
              by category from the homepage.
            </p>
          </LegalSection>
          ...
          <LegalSection title="Accuracy and transparency">
            ...
            <p>
              Results are estimates. Taxes, fees, health conditions, and personal circumstances
              can change real outcomes. Use CalcZen as a starting point—not a substitute for
          ...
          <LegalSection title="Built for you">
            <ul>
              ...
              <li>
                <strong>Educational</strong> — we explain the math, especially for finance and
                health topics where context matters
              </li>
            </ul>
          </LegalSection>
          ...
          <LegalSection title="How we stay free">
            <p>
              ...
              your personal data. Details on cookies, Google Analytics, and Google AdSense are in
