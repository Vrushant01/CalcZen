...
export function BMRCalculator() {
  ...
  const comparisonRows = tdeeValues.map((a) => ({
    ...
    values: [
      `${a.tdee} kcal/day`,
      `×${a.key}`,
      `${Math.round(a.tdee * 7).toLocaleString()} kcal/wk`,
    ],
  ...
  const pdfData = hasResult
    ? {
        ...
        results: [
          ...
          {
            label: "Very Active TDEE (est.)",
            value: `${Math.round(bmr * 1.725)} kcal/day`,
            highlight: false,
          },
        ],
          ...
          >
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <XAxis
                        ...
                        domain={[
                          Math.round(sedentaryTdee * 0.9),
                          Math.round(extraActiveTdee * 1.02),
                        ]}
                      />
                      <YAxis
                        type="category"
            ...
            <DashboardSection title="Recommendations">
              <RecommendationList
                items={[
                  {
                    title: "Build muscle to raise your BMR",
                    description:
                      "Each kg of muscle burns ~13 kcal/day at rest. Adding 5 kg of lean muscle through resistance training could increase your BMR by ~65 kcal/day permanently.",
                  },
                  {
                    title: "Recalculate every 4–6 weeks",
                    description: `Your BMR changes as your weight, age, and body composition change. Recalculate when your weight shifts by more than 3–4 kg.`,
                  },
                  {
                    title: "Leverage NEAT for easy calorie burn",
                    description:
                      "Non-Exercise Activity Thermogenesis (NEAT) — walking, fidgeting, standing — can burn 200–400 extra kcal/day without formal exercise. Take stairs, walk during calls.",
                  },
                ]}
              />
            </DashboardSection>
