...
export function CalorieCalculator() {
  ...
  const goalBadge = {
    maintain: { text: "Maintain", color: "purple" as const },
    lose: { text: "Weight Loss", color: "blue" as const },
    gain: { text: "Weight Gain", color: "amber" as const },
  };
          ...
          >
            ...
            <div className="medical-alert border rounded-lg p-4 flex gap-3 text-sm">
              ...
              <div className="medical-alert-text">
                <strong className="medical-alert-title mr-1">Medical Disclaimer:</strong> This calculator provides calorie targets for informational and fitness tracking purposes only. It is not intended as medical advice or a substitute for professional nutritional counseling. Always consult with a healthcare provider or registered dietitian before starting any calorie-restricted diet, especially if you have an eating disorder, diabetes, or other medical conditions.
              </div>
            </div>
            ...
            <DashboardSection title="Key Metrics">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                ...
                <StatCard
                  ...
                  value={
                    calcGoal === "lose" ? "−500 kcal" : calcGoal === "gain" ? "+300 kcal" : "0 kcal"
                  }
                ...
                <StatCard
                  ...
                  accent="cyan"
                  subValue="1.8g per kg body weight"
                />
                <StatCard
                  index={5}
                        ...
                        <Bar dataKey="value" radius={[4, 4, 0, 0]}>
                          {calorieBars.map((entry, i) => (
                            <Cell
                              key={i}
                              fill={entry.fill}
                              opacity={entry.value === Math.round(target) ? 1 : 0.5}
                            />
                          ))}
                        </Bar>
                      </BarChart>
            ...
            <DashboardSection title="Smart Insights">
              <div className="flex flex-col gap-2">
                ...
                <InsightCard
                  index={1}
                  tone={calcGoal === "lose" ? "success" : "info"}
                  text={
                    calcGoal === "lose"
            ...
            <DashboardSection title="Recommendations">
              <RecommendationList
                items={[
                  {
                    title: "Track calories for 2–3 weeks",
                    description:
                      "Use a food tracking app (MyFitnessPal, Cronometer) for 2–3 weeks to build awareness. After calibration, intuitive eating becomes easier.",
                  },
                  {
                    title: "Adjust by 100–200 kcal if plateauing",
                    description: `If your weight isn't moving after 2 weeks, adjust your target by 100–200 kcal. Your true TDEE may differ slightly from the calculated ${Math.round(tdee)} kcal.`,
                  },
                  {
                    title: "Prioritize protein and fiber",
                    description: `Hit your ${proteinTarget}g protein target and include high-fiber vegetables — both reduce hunger and support sustainable adherence to your calorie goal.`,
                  },
                ]}
              />
            </DashboardSection>
