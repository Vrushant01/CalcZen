...
export function TipCalculator() {
  ...
  return (
    <CalculatorPageLayout
      ...
      faqs={[
        { q: "What is a tip calculator?", a: "A tip calculator is an everyday lifestyle billing tool that automatically calculates gratuity amounts and splits dining bills evenly among friends or group diners. It factors in local sales tax and custom tip percentages, helping you avoid confusing mental math and awkward manual calculations at the end of a meal." },
        { q: "Should I calculate tips before or after sales tax?", a: "Standard tipping etiquette dictates that you should calculate tips based on the pre-tax bill amount, as tax is a government levy and not a service component. However, tipping on the final post-tax total is common and appreciated by service staff. Set custom percentage parameters with our <a href=\"/calculator/percentage-calculator\" class=\"text-primary hover:underline\">Percentage Calculator</a>." },
        { q: "What is a standard tipping rate?", a: "In the United States, a standard tip for sit-down restaurant dining is 15% to 20% of the pre-tax bill amount, with 18% being the most common average tip. For simple buffet service or bar staff, 10% to 15% is customary, while exceptional service or large groups often warrant 22% or more." },
        { q: "How do I split a bill unevenly among friends?", a: "To split a restaurant bill unevenly, you must calculate each diner's individual food and drink subtotal, add their share of the local sales tax, and apply the chosen tip percentage. While our calculator splits bills evenly for simplicity, you can perform quick individual arithmetic checks using our standard <a href=\"/calculator/standard-calculator\" class=\"text-primary hover:underline\">Standard Calculator</a>." },
        { q: "What should I do if a service charge is already included?", a: "If a 'service charge' or 'automatic gratuity' is already printed on your dining bill (which is common for large groups of six or more people), you do not need to add any additional tip. Check your bill receipt closely to ensure you do not tip twice, though you can always add extra cash for stellar service." },
        { q: "Is it customary to tip on takeout orders?", a: "Tipping on takeout food orders is not strictly mandatory, but it is customary and appreciated to leave 10% to 15% of the total cost to show appreciation for the kitchen staff who prepare and package your food. During busy periods, leaving a small tip helps support hardworking restaurant and hospitality staff." },
        { q: "Should I tip delivery drivers?", a: "Yes, it is highly recommended to tip food delivery drivers 10% to 15% of the order total, with a minimum tip of $3 to $5, to compensate them for their travel time, vehicle wear, and fuel costs. Tipping drivers helps ensure prompt service and directly supports these gig economy workers." },
        { q: "How do I calculate tip percentages manually?", a: "To calculate a tip percentage manually, find 10% of the bill by moving the decimal point one place to the left, then double that amount to find a 20% tip, or add half of that 10% value to estimate a 15% tip. Our tip calculator automates this arithmetic to prevent billing mistakes at the table." }
      ]}
