      ...
      <div className="w-full min-w-0 space-y-5 sm:space-y-8">
        ...
        {formula && (
          <section className="surface-card rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 min-w-0">
            <h2 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Formula</h2>
            <pre className="text-xs sm:text-sm bg-muted rounded-lg p-3 sm:p-5 overflow-x-auto whitespace-pre-wrap leading-relaxed max-w-full">
              {formula}
            </pre>
          </section>
        )}
        ...
        {example && (
          <section className="surface-card rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 min-w-0">
            <h2 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Example</h2>
            <p className="select-copy text-sm sm:text-base text-muted-foreground leading-relaxed whitespace-pre-line">
              {example}
            </p>
          </section>
        )}
