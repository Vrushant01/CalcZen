...
const CONTEXTUAL_LINKS_DICT: Record<string, Record<string, string>> = {
  "mortgage-calculator": {
    "loan-emi-calculator":
      "Compare home loans and monthly installments with our [Loan EMI Calculator](/calculator/loan-emi-calculator).",
    "compound-interest-calculator":
      "Estimate interest accumulation and investment growth using the [Compound Interest Calculator](/calculator/compound-interest-calculator).",
    "percentage-calculator":
      "Perform quick ratio shifts and percentage calculations with the [Percentage Calculator](/calculator/percentage-calculator).",
    "retirement-calculator":
      "Plan your long-term retirement savings and corpus targets using our [Retirement Calculator](/calculator/retirement-calculator).",
    "401k-calculator":
      "Optimize retirement savings and pre-tax contributions using the [401(k) Calculator](/calculator/401k-calculator).",
  },
  "compound-interest-calculator": {
    "loan-emi-calculator":
      "Determine borrowing installments and compare loan options with our [Loan EMI Calculator](/calculator/loan-emi-calculator).",
    "mortgage-calculator":
      "Calculate monthly home loan amortizations using the [Mortgage Calculator](/calculator/mortgage-calculator).",
    "percentage-calculator":
      "Examine compound growth ratios and percent shifts using our [Percentage Calculator](/calculator/percentage-calculator).",
    "retirement-calculator":
      "Estimate retirement corpus targets and nest eggs using the [Retirement Calculator](/calculator/retirement-calculator).",
    "401k-calculator":
      "Model pre-tax growth and employer matching with our [401(k) Calculator](/calculator/401k-calculator).",
  },
  "loan-emi-calculator": {
    "mortgage-calculator":
      "Estimate your monthly property payments using the [Mortgage Calculator](/calculator/mortgage-calculator).",
    "compound-interest-calculator":
      "Foresee long-term investment growth and compound returns with the [Compound Interest Calculator](/calculator/compound-interest-calculator).",
    "tip-calculator":
      "Divide dining expenditures and calculate gratuity with our [Tip Calculator](/calculator/tip-calculator).",
    "retirement-calculator":
      "Secure your long-term savings goals and nest egg using the [Retirement Calculator](/calculator/retirement-calculator).",
    "401k-calculator":
      "Determine pre-tax contributions and employer match with our [401(k) Calculator](/calculator/401k-calculator).",
  },
  "retirement-calculator": {
    "401k-calculator":
      "Optimize employer matching and contribution limits using the [401(k) Calculator](/calculator/401k-calculator).",
    "compound-interest-calculator":
      "Project investment compounding over time with our [Compound Interest Calculator](/calculator/compound-interest-calculator).",
    "loan-emi-calculator":
      "Calculate borrowing costs and personal loan EMIs using our [Loan EMI Calculator](/calculator/loan-emi-calculator).",
    "mortgage-calculator":
      "Simulate home purchase financing costs using the [Mortgage Calculator](/calculator/mortgage-calculator).",
    "percentage-calculator":
      "Track savings growth ratios using the [Percentage Calculator](/calculator/percentage-calculator).",
  },
  "401k-calculator": {
    "retirement-calculator":
      "Secure your financial future by planning corpus goals using the [Retirement Calculator](/calculator/retirement-calculator).",
    "compound-interest-calculator":
      "Forecast long-term savings growth using our [Compound Interest Calculator](/calculator/compound-interest-calculator).",
    "loan-emi-calculator":
      "Determine monthly loan installments with the [Loan EMI Calculator](/calculator/loan-emi-calculator).",
    "mortgage-calculator":
      "Calculate home buying payment plans using our [Mortgage Calculator](/calculator/mortgage-calculator).",
    "percentage-calculator":
      "Track compound growth ratios using the [Percentage Calculator](/calculator/percentage-calculator).",
  },
  "bmi-calculator": {
    "calorie-calculator":
      "To better understand your daily energy and calorie needs, try our [Calorie Calculator](/calculator/calorie-calculator).",
    "bmr-calculator":
      "Use the [BMR Calculator](/calculator/bmr-calculator) to estimate your basal metabolic rate and resting energy expenditure.",
  ...
  "calorie-calculator": {
    "bmr-calculator":
      "Establish your basal metabolic rate as a baseline using the [BMR Calculator](/calculator/bmr-calculator).",
    "bmi-calculator":
      "Analyze your body weight index relative to height using our [BMI Calculator](/calculator/bmi-calculator).",
    "water-intake-calculator":
  ...
  "water-intake-calculator": {
    "calorie-calculator":
      "Verify daily energy goals and macronutrient needs using our [Calorie Calculator](/calculator/calorie-calculator).",
    "bmi-calculator":
      "Keep track of weight indexes and health targets with our [BMI Calculator](/calculator/bmi-calculator).",
    "bmr-calculator":
  ...
  "bmr-calculator": {
    "calorie-calculator":
      "Translate resting metabolism into custom daily targets with our [Calorie Calculator](/calculator/calorie-calculator).",
    "bmi-calculator":
      "Evaluate body weight status relative to height using the [BMI Calculator](/calculator/bmi-calculator).",
    "water-intake-calculator":
  ...
  "pregnancy-due-date-calculator": {
    "water-intake-calculator":
      "Stay hydrated throughout pregnancy by calculating targets with the [Water Intake Calculator](/calculator/water-intake-calculator).",
    "bmi-calculator":
      "Assess weight ranges and monitor overall physical fitness with our [BMI Calculator](/calculator/bmi-calculator).",
    "calorie-calculator":
  ...
  "percentage-calculator": {
    "tip-calculator":
      "Determine dining bill divisions and tip rates using our [Tip Calculator](/calculator/tip-calculator).",
    "age-calculator":
      "Perform chronological calculations and birth countdowns with the [Age Calculator](/calculator/age-calculator).",
    "compound-interest-calculator":
  ...
  "age-calculator": {
    "percentage-calculator":
      "Evaluate ratios, differences, and percentage shifts using the [Percentage Calculator](/calculator/percentage-calculator).",
    "tip-calculator":
  ...
  "tip-calculator": {
    "percentage-calculator":
      "Evaluate bill discounts, price markups, and percent shifts using our [Percentage Calculator](/calculator/percentage-calculator).",
    "loan-emi-calculator":
  ...
  "standard-calculator": {
    ...
    "percentage-calculator":
      "Determine percent shifts and ratio math equations with the [Percentage Calculator](/calculator/percentage-calculator).",
    "tip-calculator":
      "Split restaurant tabs and calculate gratuity percentages with the [Tip Calculator](/calculator/tip-calculator).",
  },
};
...
function renderContextualSentence(sentence: string) {
  ...
  while ((match = regex.exec(sentence)) !== null) {
    ...
    parts.push(
      <Link key={index} to={to as any} className="text-primary hover:underline font-medium">
        {text}
      </Link>,
    );
...
const AUTHORITY_CITATIONS_DICT: Record<string, { name: string; url: string }[]> = {
  "mortgage-calculator": [
    {
      name: "Consumer Financial Protection Bureau Mortgage Guide",
      url: "https://www.consumerfinance.gov/owning-a-home/",
    },
    {
      name: "Federal Reserve Board Mortgage Calculator Resources",
      url: "https://www.federalreserve.gov/consumerscommunities/mortgagecalculator.htm",
    },
  ],
  "compound-interest-calculator": [
    {
    ...
    {
      name: "FINRA Guide on Compound Interest",
      url: "https://www.finra.org/investors/insights/power-of-compound-interest",
    },
  ],
  "loan-emi-calculator": [
    {
      name: "Consumer Financial Protection Bureau Loan Toolkits",
      url: "https://www.consumerfinance.gov/consumer-tools/loans/",
    },
    {
      name: "Federal Reserve Board Consumer Loans Guide",
      url: "https://www.federalreserve.gov/consumerscommunities/personal-loans.htm",
    },
  ],
  "retirement-calculator": [
    {
      name: "Social Security Administration Retirement Planner",
  ...
  "401k-calculator": [
    {
      name: "IRS 401(k) Plan Contribution Limits",
      url: "https://www.irs.gov/retirement-plans/401k-plans",
    },
    {
      name: "US Department of Labor 401(k) Plan Information",
      url: "https://www.dol.gov/agencies/ebsa/key-topics/retirement/401k-plans",
    },
  ],
  "bmi-calculator": [
    {
      name: "World Health Organization Obesity and Overweight Guidelines",
      url: "https://www.who.int/europe/news-room/fact-sheets/item/obesity-and-overweight",
    },
    { name: "CDC Body Mass Index Criteria", url: "https://www.cdc.gov/bmi/index.html" },
    {
      name: "NIH Weight Management Resources",
      url: "https://www.nhlbi.nih.gov/health/educational/lose_wt/index.htm",
    },
  ],
  "calorie-calculator": [
    {
      name: "NIH Body Weight Planner & Calorie Guidelines",
      url: "https://www.nih.gov/news-events/nih-research-matters/weight-loss-planner-launched",
    },
    { name: "USDA Dietary Guidelines for Americans", url: "https://www.dietaryguidelines.gov" },
  ],
  "water-intake-calculator": [
    {
      name: "National Academies Report on Daily Water Requirements",
  ...
  "pregnancy-due-date-calculator": [
    ...
    {
      name: "NIH Pregnancy Milestone and Due Date Guidelines",
      url: "https://www.nichd.nih.gov/health/topics/pregnancy/conditioninfo/default",
    },
  ],
  "percentage-calculator": [
    {
      name: "Wolfram MathWorld Percentage Reference",
      url: "https://mathworld.wolfram.com/Percentage.html",
    },
    {
      name: "NIST Metrics and Decimal Ratios Guide",
      url: "https://www.nist.gov/pml/owm/metric-si/si-units",
    },
  ],
  "age-calculator": [
    {
      name: "NIST Time and Frequency Division Standards",
  ...
  "tip-calculator": [
    {
      name: "Cornell University Gratuity and Tipping Research",
      url: "https://sha.cornell.edu/about/directory/instructors/mlm15/",
    },
    {
      name: "Consumer Reports Service Gratuity Guidelines",
      url: "https://www.consumerreports.org/tipping-service-workers/gratuity-guide-a2795863994/",
    },
  ],
  "scientific-calculator": [
    {
      name: "NIST Reference on Physics Constants and Units",
      url: "https://physics.nist.gov/cuu/Constants/",
    },
    {
      name: "Wolfram MathWorld Mathematical Function Reference",
...
export function CalculatorPageLayout({
  ...
  const getRelatedCalculators = (): typeof calculators => {
    ...
    const categoryMatches = calculators.filter(
      (c) =>
        c.category === calc.category && c.slug !== calc.slug && !semanticSlugs.includes(c.slug),
    );
    ...
    <PageContainer spacing="tight" className="lg:py-10">
      ...
      >
        ...
        <div className="mt-3 sm:mt-4 flex flex-wrap gap-2">
          <Button variant="outline" size="sm" onClick={share} className="gap-2 min-h-10 sm:min-h-9">
      ...
      <div className="w-full min-w-0 space-y-5 sm:space-y-8">
        ...
        {blog && <div className="w-full min-w-0">{blog}</div>}
        ...
        <section
          id="faq-section"
          className="scroll-mt-20 surface-card rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 min-w-0 text-left"
        >
          <h2 className="text-xl sm:text-2xl font-bold mb-6 border-b border-border/40 pb-3">
        ...
        {related.length > 0 && (
          <section className="min-w-0 surface-card rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 text-left mt-5 sm:mt-8">
            <h2 className="text-xl sm:text-2xl font-bold mb-4 border-b border-border/40 pb-3">
              Related Calculators
            </h2>
