    ...
    sections: [
      ...
      },
      {
        ...
        exampleBox: {
          ...
          result: "Your monthly loan EMI is <strong>$484.01</strong>. Over the course of 36 months, you will repay a total of <strong>$17,424.36</strong>, of which <strong>$2,424.36</strong> is pure interest paid to the lender."
        }
      },
      {
        title: "When To Use This Calculator",
      ...
      },
      {
        ...
        formulaBox: {
          ...
          variables: [
            ...
            { name: "703", desc: "Conversion multiplier to align imperial units with the metric scale" }
          ]
        }
      },
      {
        ...
        exampleBox: {
          ...
          result: "The calculated BMI is <strong>25.82</strong>, placing the individual just slightly above the healthy range, into the **Overweight** category."
        }
      },
      {
        title: "When To Use This Calculator",
    ...
    sections: [
      ...
      },
      {
        ...
        exampleBox: {
          ...
          result: "Your future investment balance grows to <strong>$10,048.31</strong>, giving you a profit of <strong>$5,048.31</strong> in pure compounded growth without ever adding another dollar."
        }
      },
      {
        title: "When To Use This Calculator",
    ...
    sections: [
      ...
      },
      {
        ...
        formulaBox: {
          ...
          formula: "Tip Amount = Subtotal * (Tip Pct / 100)  |  Total Bill = Subtotal + Tip + Tax  |  Per Person = Total Bill / Group Size",
          variables: [
      ...
      },
      {
        ...
        exampleBox: {
          ...
          result: "The grand total bill is <strong>$126.50</strong>. Since $31.625 cannot be perfectly paid in cents, each person owes exactly <strong>$31.63</strong> (with one person paying a penny less)."
        }
      },
      {
        title: "When To Use This Calculator",
    ...
    sections: [
      ...
      },
      {
        ...
        exampleBox: {
          ...
          result: "Your final purchase price is <strong>$84</strong>, representing a total combined discount of <strong>44%</strong> off the original price, NOT the 50% you might have initially assumed."
        }
      },
      {
        title: "When To Use This Calculator",
    ...
    sections: [
      ...
      },
      {
        ...
        exampleBox: {
          ...
          result: "Your exact chronological age is <strong>31 years, 1 month, and 14 days</strong>. In total absolute days, factoring in leap years, you have been alive for <strong>11,367 days</strong>!"
        }
      },
      {
        title: "When To Use This Calculator",
    ...
    sections: [
      ...
      },
      {
        ...
        formulaBox: {
          ...
          formula: "BMR = (10 * weight in kg) + (6.25 * height in cm) - (5 * age in years) + S  |  TDEE = BMR * Activity Multiplier",
          variables: [
            { name: "S (Sex Constant)", desc: "+5 for Men, -161 for Women" },
            { name: "Activity Multiplier", desc: "Ranges from 1.2 (Sedentary) to 1.9 (Extremely Active)" }
          ]
        }
      },
      {
      ...
      },
      {
        ...
        formulaBox: {
          ...
          variables: [
            ...
            { name: "35 / 10", desc: "Standard clinical multipliers for maintenance and sweat loss" }
          ]
        }
      },
      {
        ...
        exampleBox: {
          ...
          result: "Your daily fluid intake target is <strong>3,250 mL (3.25 Liters)</strong>, which is approximately <strong>110 ounces</strong> of water per day."
        }
      },
      {
        title: "When To Use This Calculator",
    ...
    sections: [
      ...
      },
      {
        ...
        exampleBox: {
          ...
          result: "Your Estimated Due Date (EDD) is <strong>June 17, 2026</strong>. You are currently on track for a full-term 40-week (280-day) pregnancy."
        }
      },
      {
        title: "When To Use This Calculator",
    ...
    sections: [
      {
        ...
        formulaBox: {
          ...
          variables: [
            ...
            { name: "Constants (+5 or -161)", desc: "Biological sex modifiers derived from clinical trials" }
          ]
        }
      },
      {
        ...
        exampleBox: {
          ...
          result: "Your Basal Metabolic Rate (BMR) is <strong>1,780 calories</strong> per day. This is the energy your body burns just staying alive in a resting state, before any physical activity is added."
        }
      },
      {
        title: "When To Use This Calculator",
    ...
    sections: [
      ...
      },
      {
        ...
        exampleBox: {
          ...
          result: "You have <strong>$1,400</strong> remaining in discretionary income after accounting for grouped fixed and variable expenses."
        }
      },
      {
        title: "When To Use This Calculator",
      ...
      },
      {
        ...
        formulaBox: {
          ...
          variables: [
            ...
            { name: "Annual Expenses", desc: "Expected yearly spending in retirement (minus pensions/Social Security)" },
            { name: "25", desc: "The multiplier derived from a 4% Safe Withdrawal Rate (100 / 4 = 25)" }
          ]
        }
      },
      {
        ...
        exampleBox: {
          ...
          result: "You will need a retirement corpus of <strong>$1.5 million</strong>. Withdrawing 4% of this corpus gives you your $60,000, which combined with Social Security fully funds your $80,000 lifestyle."
        }
      },
      {
        title: "When To Use This Calculator",
    ...
    sections: [
      ...
      },
      {
        ...
        exampleBox: {
          ...
          result: "At age 65, the 401(k) balance will be approximately <strong>$1.08 million</strong>. You only personally contributed $168,000, while the employer match and compound growth provided the remaining $911,856!"
        }
      },
      {
        title: "When To Use This Calculator",
