...
export const calculators: CalculatorMeta[] = [
  ...
  },
  {
    ...
    category: "finance",
    description: "Plan your future retirement savings. Estimate your needed corpus, income gaps, and years your savings will last with advanced scenario modeling.",
    keywords: ["retirement calculator", "online retirement calculator", "free retirement calculator", "retirement savings planner", "retirement corpus"],
  ...
  },
  {
    ...
    category: "finance",
    description: "Estimate your 401(k) account growth, compound returns, and maximize your employer matching contributions easily.",
    keywords: ["401k calculator", "401k match calculator", "estimate 401k growth", "retirement match planner"],
