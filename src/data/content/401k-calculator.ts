...
const content: CalculatorEducationalContent = {
  ...
  faqs: [
    {
      question: "How accurate is the 401k calculator?",
  ...
  relatedCalculators: ["calorie-calculator","compound-interest-calculator","retirement-calculator"]
};
