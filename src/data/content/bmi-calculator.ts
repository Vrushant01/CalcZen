...
const content: CalculatorEducationalContent = {
  ...
  relatedCalculators: ["pregnancy-due-date-calculator","water-intake-calculator","bmr-calculator"]
};
