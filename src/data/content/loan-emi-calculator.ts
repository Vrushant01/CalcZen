...
const content: CalculatorEducationalContent = {
  ...
  faqs: [
    {
      question: "How accurate is the loan emi calculator?",
  ...
  relatedCalculators: ["pregnancy-due-date-calculator","compound-interest-calculator","scientific-calculator"]
};
