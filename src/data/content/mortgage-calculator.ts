...
const content: CalculatorEducationalContent = {
  ...
  relatedCalculators: ["compound-interest-calculator","calorie-calculator","pregnancy-due-date-calculator"]
};
