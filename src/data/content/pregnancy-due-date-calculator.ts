  ...
  faqs: [
    {
      ...
      answer: "The calculator uses industry-standard formulas and provides highly accurate estimates based on the exact data you input. However, for critical medical or financial decisions, it should be used as a baseline guide alongside professional advice."
    },
    {
      question: "Can I use this calculator on my mobile device?",
      answer: "Yes, the calculator is fully responsive and optimized for all devices, including smartphones, tablets, and desktop computers."
    },
    {
      question: "Do I need to create an account to use the tool?",
      answer: "No, all of our calculators are completely free to use and do not require any registration or account creation."
    },
    {
      question: "How often should I recalculate my numbers?",
      answer: "It is recommended to recalculate whenever your primary variables—such as income, weight, interest rates, or age—change significantly."
    },
    {
      question: "Is my inputted data saved or shared?",
      answer: "Your privacy is our priority. All calculations are performed locally in your browser, and no personal input data is saved or transmitted to our servers."
    }
  ],

  authorityLinks: [
    { text: "World Health Organization (WHO)", url: "https://www.who.int/" },
    { text: "Centers for Disease Control and Prevention (CDC)", url: "https://www.cdc.gov/" }
  ],

  relatedCalculators: ["bmi-calculator","401k-calculator","mortgage-calculator"]
};
