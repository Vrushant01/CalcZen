...
const content: CalculatorEducationalContent = {
  ...
  faqs: [
    {
      question: "How accurate is the retirement calculator?",
  ...
  relatedCalculators: ["standard-calculator","age-calculator","mortgage-calculator"]
};
