...
const content: CalculatorEducationalContent = {
  ...
  faqs: [
    {
      question: "How accurate is the standard calculator?",
  ...
  relatedCalculators: ["loan-emi-calculator","tip-calculator","compound-interest-calculator"]
};
