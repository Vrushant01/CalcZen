...
const content: CalculatorEducationalContent = {
  ...
  faqs: [
    {
      question: "How accurate is the tip calculator?",
  ...
  relatedCalculators: ["retirement-calculator","scientific-calculator","water-intake-calculator"]
};
