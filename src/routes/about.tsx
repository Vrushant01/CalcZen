...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About CalcVerse — Free Online Calculators for Finance, Health & Math" },
      {
        name: "description",
        content:
          "About CalcVerse: free, accurate online calculators for finance, health, math, and everyday use. Transparent formulas and a clean experience on any device.",
      },
      { property: "og:title", content: "About CalcVerse — Free Online Calculators" },
      {
        property: "og:description",
        content:
          "Learn how CalcVerse delivers fast, accurate calculator tools with clear methods and a distraction-free experience.",
      },
  ...
  return (
    <PageShell>
      <LegalArticle
        ...
        intro="CalcVerse is a free calculator platform for everyday financial, health, and math questions—built to be fast, accurate, and clear about how every result is calculated."
      >
        <LegalSection title="Our mission">
          <p>
            Calculator sites are often cluttered or opaque. CalcVerse focuses on what matters: a
        ...
        <LegalSection title="Accuracy and transparency">
          ...
          <p>
            ...
            change real outcomes. Use CalcVerse as a starting point—not a substitute for
        ...
        <LegalSection title="How we stay free">
          <p>
            CalcVerse is supported by advertising and privacy-conscious analytics. We do not sell
