...
export const Route = createFileRoute("/disclaimer")({
  head: () => ({
    meta: [
      { title: "Disclaimer — Calculator Use & Limitations | CalcVerse" },
      {
        name: "description",
        content:
          "CalcVerse Disclaimer: free online calculators are for informational use only—not financial, medical, or legal advice. Read before relying on results.",
      },
      { property: "og:title", content: "CalcVerse Disclaimer" },
      {
        property: "og:description",
        content: "Important limits on how CalcVerse finance, health, and math calculator results should be used.",
      },
  ...
  return (
    <PageShell>
      <LegalArticle
        ...
        intro="CalcVerse calculators help you estimate and learn—they are not a substitute for professional advice. Please read these limits before using finance, health, or math tools on this site."
      >
        <LegalSection title="Informational use only">
          ...
          <p>
            By using CalcVerse, you agree to this Disclaimer, our{" "}
        ...
        <LegalSection title="Finance calculators">
          <p>
            ...
            solely on CalcVerse for binding financial commitments.
          </p>
        </LegalSection>
        ...
        <LegalSection title="Limitation of liability">
          <p>
            To the fullest extent permitted by law, CalcVerse disclaims liability for loss or harm
        ...
        <LegalSection title="Updates and contact">
          ...
          <p>
            ...
            <Link to="/about">About CalcVerse</Link>.
          </p>
        </LegalSection>
      </LegalArticle>
    </PageShell>
