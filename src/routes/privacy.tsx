...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — How CalcVerse Handles Your Data" },
      {
        name: "description",
        content:
          "CalcVerse Privacy Policy: what data we collect, cookies, Google Analytics, Google AdSense, your rights, and how we protect information when you use our free online calculators.",
      },
      { property: "og:title", content: "CalcVerse Privacy Policy" },
      {
        property: "og:description",
        content: "How CalcVerse handles data, cookies, analytics, and advertising on our calculator platform.",
      },
  ...
  return (
    <PageShell>
      <LegalArticle
        ...
        intro="This policy explains how CalcVerse collects, uses, and protects information when you use our website and free online calculators. We aim to be transparent and handle data responsibly."
      >
        <LegalSection title="Overview">
          <p>
            You can use CalcVerse without an account. Calculator inputs are processed in your
        ...
        <LegalSection title="How we use information">
          <ul>
            <li>Operate and improve CalcVerse and our accurate calculator tools</li>
        ...
        <LegalSection title="Cookies">
          <p>
            Cookies are small files stored on your device. CalcVerse and partners may use them for
        ...
        <LegalSection title="Advertising and Google AdSense">
          <p>
            CalcVerse may show ads from <strong>Google AdSense</strong> or other partners to help
            cover costs. Partners may use cookies to:
          </p>
          <ul>
            <li>Serve ads on CalcVerse and other sites you visit</li>
        ...
        <LegalSection title="Children and international visitors">
          <p>
            CalcVerse is for a general audience. We do not knowingly collect personal information
