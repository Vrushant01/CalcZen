...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service — Using CalcVerse Calculators" },
      {
        name: "description",
        content:
          "CalcVerse Terms of Service: rules for using our free online calculators, including educational use, accuracy limits, intellectual property, and liability.",
      },
      { property: "og:title", content: "CalcVerse Terms of Service" },
      {
        property: "og:description",
        content: "Terms governing your use of CalcVerse free finance, health, and math calculator tools.",
      },
  ...
  return (
    <PageShell>
      <LegalArticle
        ...
        intro="These Terms govern your use of CalcVerse—including all free online calculators and related content. By using the site, you agree to these Terms."
      >
        <LegalSection title="About CalcVerse">
          <p>
            CalcVerse provides free calculator tools for finance, health, math, and everyday use,
            for informational and educational purposes. These Terms apply to all visitors.
          </p>
        </LegalSection>

        <LegalSection title="Acceptable use">
          <p>You agree to use CalcVerse lawfully. You must not:</p>
          <ul>
        ...
        <LegalSection title="Educational purpose">
          ...
          <p>
            Nothing on CalcVerse is financial, investment, tax, legal, or medical advice. See our{" "}
        ...
        <LegalSection title="Your responsibility">
          <p>
            You are responsible for how you use CalcVerse and any decisions based on calculator
        ...
        <LegalSection title="Third-party links">
          <p>
            ...
            CalcVerse. Use them at your own risk under their terms and policies.
          </p>
        </LegalSection>
        ...
        <LegalSection title="Limitation of liability">
          <p>
            To the fullest extent permitted by law, CalcVerse is not liable for indirect, incidental,
        ...
        <LegalSection title="Indemnification">
          <p>
            You agree to indemnify CalcVerse from claims arising from your misuse of the site or
        ...
        <LegalSection title="Changes, governing law, and contact">
          ...
          <p>
            These Terms are governed by applicable laws where CalcVerse operates, without regard to
